...
function buildCertCard(cert) {
    return '<div class="cert-card" data-cert-id="' + cert.id + '"><img class="cert-card__image" src="' + cert.imageData + '" alt="' + cert.title + '" loading="lazy"><div class="cert-card__overlay"><div class="cert-card__dot-wrap"><button class="cert-card__dot-btn" data-cert-id="' + cert.id + '" aria-label="Actions"><i data-lucide="ellipsis-vertical"></i></button><div class="cert-dropdown" data-dropdown-for="' + cert.id + '"><button class="cert-dropdown__item" data-action="edit" data-cert-id="' + cert.id + '"><i data-lucide="pencil"></i> Edit</button><button class="cert-dropdown__item cert-dropdown__item--danger" data-action="delete" data-cert-id="' + cert.id + '"><i data-lucide="trash-2"></i> Delete</button></div></div><div class="cert-card__info"><span class="cert-card__info-title">' + escapeHtml(cert.title) + '</span><span class="cert-card__info-license">Credential ID: ' + escapeHtml(cert.license) + '</span></div></div></div>';
}
